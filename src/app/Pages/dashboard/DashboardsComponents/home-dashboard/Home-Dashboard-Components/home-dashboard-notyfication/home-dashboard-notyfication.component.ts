...
@Component({
  selector: 'app-home-dashboard-notyfication',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './home-dashboard-notyfication.component.html',
  styleUrl: './home-dashboard-notyfication.component.scss',
   animations: [
      trigger('fadeInOut', [
        transition(':enter', [
...
export class HomeDashboardNotyficationComponent {
